        ...
        >
            ...
            >
                <header className="flex justify-between items-center p-4 border-b border-[var(--border-primary)]">
                    <h2 className="text-xl font-bold text-[var(--text-primary)]">{t('code.saveFileAs')}</h2>
                ...
                <div className="p-6 space-y-4">
                    <p className="text-sm text-[var(--text-secondary)]">{t('code.saveDesc')}</p>
                    <InputWrapper>
                        <Label htmlFor="codeFileName" title={t('code.fileNameDesc')}>{t('code.fileName')}</Label>
                    ...
                    {extension === '.txt' && (
                        <div className="pl-[104px]"> {/* Align with input fields (w-24 label + 0.5rem gap) */}
                            <Checkbox
                                ...
                                label={t('code.saveLineNumbers')}
                                title={t('code.saveLineNumbersDesc')}
                            />
                        </div>
                    )}
                </div>
