                    ...
                    >
                        ...
                        <section>
                            ...
                            <ul className="list-decimal list-inside space-y-3 pl-2">
                                ...
                                <ListItem>
                                 ...
                                 <ListItem>
                                    <strong className="text-[var(--text-primary)]">Робоча область (Полотно):</strong> Центральна частина, де ви малюєте та редагуєте об'єкти. Полотно має налаштовуваний розмір та колір тла. Навколо нього можуть бути розташовані лінійки для точного позиціонування.
                                </ListItem>
                                <ListItem>
                            ...
                            <Para>
                                Щоб вийти з цього режиму, натисніть <Key>F11</Key> ще раз або <strong className="text-[var(--text-primary)]">утримуйте клавішу <Key>Escape (Esc)</Key> протягом 2 секунд</strong>. Утримування запобігає випадковому виходу з режиму.
                            </Para>
                        </section>
                        ...
                        <section>
                            ...
                            <ul className="list-disc list-inside space-y-2 pl-2">
                                ...
                                <ListItem>
                                    <Key>Середня кнопка миші (натиснути й тягнути)</Key> — Панорамування полотна.
                                </ListItem>
                                 <ListItem>
                                    <Key>F11</Key> — Вхід / вихід з повноекранного режиму.
                                </ListItem>
                                <ListItem>
                                    <Key>Escape (Esc)</Key> — Скасовує поточну дію (наприклад, малювання полілінії), знімає виділення з об'єкта або закриває активні модальні вікна. Також виходить з повноекранного режиму (потрібно <strong className="text-[var(--text-primary)]">утримувати 2 секунди</strong>).
                                </ListItem>
                            </ul>
                        </section>
                    </div>
