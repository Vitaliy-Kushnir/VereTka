                    ...
                    >
                        ...
                        <section>
                            ...
                            <ul className="list-disc list-inside space-y-2 pl-2">
                                ...
                                <ListItem>
                                    <strong className="text-[var(--text-primary)]">Керування об'єктом:</strong> З імпортованим зображенням можна працювати як зі звичайним об'єктом: переміщувати, масштабувати, обертати та змінювати його порядок у списку об'єктів. Це дозволяє, наприклад, розмістити його на задньому плані для зручного обведення.
                                </ListItem>
                                <ListItem>
