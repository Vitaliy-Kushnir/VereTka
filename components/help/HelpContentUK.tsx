        ...
        <>
            <section>
                        ...
                        <section>
                            ...
                            <Para>
                                Виберіть інструмент на лівій панелі та клацніть на полотні, щоб почати малювати. Для більшості фігур потрібно затиснути ліву кнопку миші та потягнути, щоб визначити розмір. Інструменти, як-от <Key>Ламана</Key> та <Key>Крива</Key>, вимагають послідовних клацань для додавання вузлів.
                            </Para>
                            <Para>
                            ...
                            <SubTitle>Групування об'єктів</SubTitle>
                            <Para>
                                Ви можете об'єднувати декілька фігур у <strong>Групу</strong> для зручнішого переміщення, масштабування та обертання як єдиного цілого. 
                                Щоб згрупувати об'єкти, виділіть їх, натисніть праву кнопку миші та виберіть <Key>Згрупувати</Key> (або скористайтеся кнопкою на панелі чи <Key>Ctrl+G</Key>). 
                                Щоб розгрупувати, виділіть групу та виберіть <Key>Розгрупувати</Key> (<Key>Ctrl+Shift+G</Key>). 
                                Подвійний клік по групі дозволяє увійти в неї для редагування окремих елементів.
                            </Para>
                            <SubTitle>Вирівнювання та розподіл</SubTitle>
                            <Para>
                                На верхній панелі інструментів доступні функції вирівнювання виділених об'єктів (за лівим/правим краєм, по центру тощо). Ви можете вирівнювати об'єкти <strong>відносно виділення</strong> або <strong>відносно полотна</strong>.
                                <br/><br/>
                                <strong>Розподіл:</strong> Ви можете рівномірно розподілити вибрані об'єкти по горизонталі або вертикалі. Також доступний <strong>Розподіл за шляхом</strong> — унікальна можливість розмістити об'єкти вздовж іншого вибраного контуру (лінії, кривої чи будь-якої фігури). 
                                Під час розподілу за шляхом можна налаштувати орієнтацію (радіальну, дотичну, паралельну) та кут нахилу об'єктів.
                            </Para>
                            <SubTitle>Список об'єктів та шари</SubTitle>
                            <Para>
                                У правій панелі знаходиться список усіх фігур на полотні. Ви можете перейменовувати фігури (подвійний клік на назву), блокувати їх (щоб запобігти випадковим змінам) або приховувати (змінювати видимість).
                                <br/><br/>
                                Порядок у списку відповідає <strong>порядку (шарам) відображення</strong>: об'єкт, що вище у списку, буде поверх тих, що нижче. Змінюйте порядок, перетягуючи фігури у списку.
                            </Para>
                            <SubTitle>Віддзеркалення (Фліп)</SubTitle>
                            <Para>
