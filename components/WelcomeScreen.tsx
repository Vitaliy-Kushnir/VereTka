                        ...
                        <div className="flex justify-center">
                            <div className="w-full md:w-2/3 lg:w-1/2">
                                <button
                                    ...
                                    className="w-full group flex items-center justify-between p-3.5 sm:p-4 bg-gradient-to-r from-sky-500/10 via-indigo-500/10 to-purple-500/10 hover:from-sky-500/20 hover:via-indigo-500/20 hover:to-purple-500/20 text-left rounded-xl sm:rounded-2xl border border-sky-500/25 hover:border-sky-500/40 transition-all duration-300 shadow-xs hover:shadow-md active:scale-98"
                                >
                                    <div className="flex items-center gap-3.5 sm:gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs sm:text-sm text-[var(--text-secondary)] mt-0.5">
                                                {t('welcome.pwa.desc') || 'Додайте Веретку на головний екран смартфону для швидкого запуску та малювання без інтернету.'}
                                            </p>
                                        </div>
                                    </div>
                                    <div className="hidden xs:flex items-center justify-center w-8 h-8 rounded-full bg-sky-500/20 text-sky-400 group-hover:translate-x-1 transition-transform shrink-0 ml-2">
